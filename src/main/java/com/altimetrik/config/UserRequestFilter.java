...
import com.altimetrik.service.JwtUserDetailsService;
...
public class UserRequestFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		// JWT Token is in the form "Altemetrik token". Remove Bearer word and get only the Token
		if (requestTokenHeader != null && requestTokenHeader.startsWith("Altemetrik ")) {
